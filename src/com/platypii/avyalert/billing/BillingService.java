...
public class BillingService extends Service implements ServiceConnection {
    ...
    abstract class BillingRequest {
         ...
         * @return true if the request ran successfully; false if the service is not connected or there was an error when trying to use it
         */
    ...
    class CheckBillingSupported extends BillingRequest {
         ...
         * Developers may want to perform two checks if both one-time and subscription products are available.
         * 
         * @pram itemType Either Consts.ITEM_TYPE_INAPP or Consts.ITEM_TYPE_SUBSCRIPTION, indicating the type of item
     ...
     * @param itemType Either Consts.ITEM_TYPE_INAPP or Consts.ITEM_TYPE_SUBSCRIPTION, indicating the type of item type
     *            support is being checked for.
