...
public class Security {
    ...
    public static ArrayList<VerifiedPurchase> verifyPurchase(String signedData, String signature) {
        ...
        if(!TextUtils.isEmpty(signature)) {
             ...
             */
            String base64EncodedPublicKey0 = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAk1eqvU9EzkyQCj7k8T5zg5t+jmRttvQXBXIFUy1Sigy8oRyYwsPrkT";
            String base64EncodedPublicKey1 = "N9UZchjaQ6m1P9LzbyoNCZxycxCtupqz+efW7Tt+3CsZjPzzA2+0ZqL+b6CPr7pkz2d95undyUk65SYM0IZC2udapLL56olm3Z";
            String base64EncodedPublicKey2 = "zejR6emgUtEs62EvfUTgQj6Ik86oSO5Z16+LiBd4EYFs9okQ91JsykbWmB4NaxP2LeKV0N1BQDBCgOV1kMvg+YSkrC31QVShSg";
            String base64EncodedPublicKey3 = "FiAWaXkRLUz7S8BgZaNF4oRD8GGjxYpbmTZYo0T+eDGwgUrbvSnMuRHWaMRY9geLid/lhWkIYRDDopJ2bueduDGeXUPwIDAQAB";
            PublicKey key = Security.generatePublicKey(base64EncodedPublicKey0 + base64EncodedPublicKey1 + base64EncodedPublicKey2 + base64EncodedPublicKey3);
